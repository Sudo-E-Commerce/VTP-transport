...
namespace Sudo\ViettelPost\Providers;
...
class ViettelPostServiceProvider extends ServiceProvider
{
     ...
     */
    private $configFile = [
        // 'SudoViettelPost' => 'SudoViettelPost.php'
    ];
     ...
     */
    protected $commands = [
       'Sudo\ViettelPost\Commands\AddressSeedCommand'
    ];
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/viettelPost');
            $this->publishes($assets, 'sudo/viettelPost/assets');
            $this->publishes($config, 'sudo/viettelPost/config');
